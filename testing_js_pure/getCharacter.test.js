...
const getAllCharacters = require("./getCharacter");

jest.mock("axios");

describe("getAllCharacters", () => {
  it("should fetch characters successfully from the API", async () => {
    const mockData = {
      info: {
        count: 826,
        pages: 42,
  ...
  it("should return an error message if the API request fails", async () => {
    ...
    axios.get.mockRejectedValue({ status: 500, statusText: errorMessage });
  ...
  it("should return the error object if an exception occurs", async () => {
